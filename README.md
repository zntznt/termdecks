...
- 📦 **Collections & Decks** — keep multiple libraries; carve any library into named **decks** (subsets of cards). A dedicated Decks window manages every deck across all collections — create, rename, delete, copy between collections, and import/export individual decks.
- ➕ **Expansions** — eight ready-made decks to start from or fold into your own: Linux, Terminal Toys, DevOps, AI-Assisted Engineering, Vim & Neovim, tmux, Git (deep), and jq + awk/sed/grep.
